...
\item
  ...
  the published ones.
\item
  '1998 parameterization of the detector response gives significantly better
...
\item
  ...
  the published ones
\item
  However, the '1992 response is consistent with the positon and the width of the 
  RPC peak published in 1992, while '1998 response - is not. 
  This confirms internal consistency of the '1992 publication 
\item
